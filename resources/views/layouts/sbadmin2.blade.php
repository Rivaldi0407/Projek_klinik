...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">klinik_098 <sup>MANTAP</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('pasien.laporan') }}">Laporan Pasien</a>
                        <a class="collapse-item" href="{{ route('dokter.laporan') }}">Laporan Dokter</a>
                        <a class="collapse-item" href="{{ route('administrasi.laporan') }}">Laporan Administrasi</a>
                </div>
            </li>
    ...
    <script src="nav-item activjs/demo/chart-pie-demo.js"></script>
